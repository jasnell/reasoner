...
var XsdGraph = require('./xsd-graph');
var LRU = require('./loading-lru-cache');
var vocabs = require('linkeddata-vocabs');
var LanguageTag = require('rfc5646');
var N3 = require('n3').Util;
...
var _graph = Symbol('graph');
var _reasoner = Symbol('reasoner');
var _id = Symbol('id');
var _cache = Symbol('cache');
var _value = Symbol('value');
var _language = Symbol('language');
var _type = Symbol('type');
var _types = Symbol('types');
var _subproperties = Symbol('subproperties');
var _subclasses = Symbol('subclasses');
var _superproperties = Symbol('superproperties');
var _superclasses = Symbol('superclasses');

var nodeCache = new LRU({
  max: 500,
  maxAge: 1000 * 60 * 60
});
...
Node.prototype = {
  ...
  is : function(type, callback) {
    ...
    if (typeof callback === 'function') {
      ...
      var answer = (find(self,{subject:self.id,
                predicate:rdf.type,
                object:type
              }).length > 0                 ||  // or
